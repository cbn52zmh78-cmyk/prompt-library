...
_KINDS: tuple[OutputKind, ...] = (
    ...
    # ---- GroundTruth satellite lanes (#282-B) -----------------------------------
    OutputKind("groundtruth_childcare", "GroundTruth/Childcare", is_dir=True,
               description="Childcare licensing lane (workspace mirror)."),
    OutputKind("groundtruth_childcare_file", "GroundTruth/Childcare", "{subpath}",
               description="Childcare lane artifact."),
    OutputKind("stonebridge_childcare_harvest",
               "Stonebridge/Operations/Compliance_Research/groundtruth/groundtruth_279_r3_ratios",
               is_dir=True, description="Childcare ratio harvest working directory."),
    OutputKind("stonebridge_childcare_harvest_file",
               "Stonebridge/Operations/Compliance_Research/groundtruth/groundtruth_279_r3_ratios",
               "{filename}", description="Childcare harvest artifact."),
    OutputKind("groundtruth_employment", "GroundTruth/Employment", is_dir=True,
               description="Employment/labor lane (workspace mirror)."),
    OutputKind("groundtruth_employment_file", "GroundTruth/Employment", "{subpath}",
               description="Employment lane artifact."),
    OutputKind("stonebridge_groundtruth_employment",
               "Stonebridge/Operations/Compliance_Research/groundtruth/Employment", is_dir=True,
               description="Stonebridge-authoritative employment lane."),
    OutputKind("stonebridge_groundtruth_employment_file",
               "Stonebridge/Operations/Compliance_Research/groundtruth/Employment", "{subpath}",
               description="Stonebridge employment lane artifact."),
    OutputKind("groundtruth_market_intel", "GroundTruth/MarketIntel", is_dir=True,
               description="Market intelligence lane (workspace mirror)."),
    OutputKind("groundtruth_market_intel_file", "GroundTruth/MarketIntel", "{subpath}",
               description="Market intel lane artifact."),
    OutputKind("stonebridge_groundtruth_market_intel",
               "Stonebridge/Operations/Compliance_Research/groundtruth/MarketIntel", is_dir=True,
               description="Stonebridge-authoritative market intel lane."),
    OutputKind("stonebridge_groundtruth_market_intel_file",
               "Stonebridge/Operations/Compliance_Research/groundtruth/MarketIntel", "{subpath}",
               description="Stonebridge market intel artifact."),
