...
## Language profile: Linear A

- **Status:** undeciphered
- **Revival tier:** research
- **Family:** Aegean (undeciphered)
- **Period:** c. 1800–1450 BCE
- **Script:** Linear A syllabary
- **Decipherment:** undeciphered
- **Training readiness:** research_only
...
### Block 1: Hagia Triada libation formula — a-sa-sa-ra-me (Post 8) `[unknown]`

**Source:** Hagia Triada libation table formula; Godart & Olivier, GORILA (1976–1985); https://en.wikipedia.org/wiki/Linear_A (CC BY-SA 3.0)
...
**Translation / gloss:**
Unknown — formulaic ritual text; meaning not deciphered

**Notes:** DAVID Post 8 hook line. Signs are attested on tablets; language and meaning unknown. Any audio is speculative — label prominently on-screen. Do not claim translation.
...
4. Queue next research via `research_query_generator.py --language linear-a`.

## Next research tasks

- Expand corpus for Linear A
