...
TOOLS = [
    ...
    ("david_brain_scheduler.py --status", "Scheduler — what runs next"),
    ("david_brain_scheduler.py --once", "Scheduler — run one batch now"),
    ("david_brain_scheduler.py --daemon --interval 3600", "Scheduler — continuous (1h interval)"),
