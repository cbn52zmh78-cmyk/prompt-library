"""Canonical paths for the Language module."""
...
WORKSPACE = LANGUAGE_ROOT.parent
...
DATA_DIR = LANGUAGE_ROOT / "data"
LANGUAGES_DIR = LANGUAGE_ROOT / "languages"
PROMPTS_DIR = LANGUAGE_ROOT / "prompts"
REGISTRY_FILE = DATA_DIR / "language_registry.json"
QUEUE_FILE = DATA_DIR / "research_queue.json"
TRAINING_OUT = LANGUAGE_ROOT / "training_packs"
RESEARCH_OUT = LANGUAGE_ROOT / "research"
