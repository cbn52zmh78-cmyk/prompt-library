...
- **Conflicts:** 717 ({"text_disagreement": 717})
...
- **R3** (Health & Personal Care): 50/50 states, 942 facts, 0 multi-source merges
...
_…and 677 more in `state_consolidation_note_v1.json`_
