...
`python DAVID/scripts/david_brain_scraper.py --language proto-indo-european`

## Classical Latin (`classical-latin`)

**Scraped:** 2026-06-16T23:07:02.611474+00:00 | **Sources:** wikipedia, wikidata, wiktionary
...
From . The medieval application to Wales is by conflation.
...
⚠️ No brain scrape yet. Run:
`python DAVID/scripts/david_brain_scraper.py --language old-english`

## Classical Japanese (`classical-japanese`)

⚠️ No brain scrape yet. Run:
`python DAVID/scripts/david_brain_scraper.py --language classical-japanese`
