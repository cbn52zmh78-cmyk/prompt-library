...
Variant shards live in DAVID/ELEANOR/training/eleanor_dataset/ named
eleanor_david_T1..T6_*.jsonl (generated by research/generate_eleanor_david_corpus.py).
...
SHARD_GLOB = "eleanor_david_T*_*.jsonl"  # variant shards: eleanor_david_T1..T6_*.jsonl
