...
- **Conflicts:** 715 ({"text_disagreement": 715})
...
- **R3** (Health & Personal Care): 50/50 states, 925 facts, 0 multi-source merges
- **R4** (Financial & Professional): 50/50 states, 1343 facts, 0 multi-source merges
- **R5** (Transport / Logistics / Auto): 50/50 states, 278 facts, 0 multi-source merges
...
_…and 675 more in `state_consolidation_note_v1.json`_
