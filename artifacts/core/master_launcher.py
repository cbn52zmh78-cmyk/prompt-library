...
TOOLS = {
    ...
    "Profile Management": [
        ("profile/model_profile_manager.py", "Model Profile Manager v1.1 (CRUD + roster export)"),
    ],
    "Prompt Generation & Quality": [
        ("prompts/fashion_modeling_prompt_generator.py", "Fashion/Modeling Prompt Generator"),
        ("prompts/batch_prompt_generator.py", "Batch Prompt Generator from JSON"),
    ...
    "Shot Listing & Video Tools": [
        ...
        ("video/onetake_choreography_builder.py", "One-Take Choreography Prompt Builder"),
    ...
    "Reference, Metadata & Catalog": [
        ...
        ("catalog/template_library_manager.py", "Master Prompt Template Library Manager"),
