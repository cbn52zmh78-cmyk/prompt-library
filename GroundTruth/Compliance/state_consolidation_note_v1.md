...
- **Conflicts:** 718 ({"text_disagreement": 718})
...
- **R3** (Health & Personal Care): 50/50 states, 948 facts, 0 multi-source merges
- **R4** (Financial & Professional): 50/50 states, 1343 facts, 0 multi-source merges
- **R5** (Transport / Logistics / Auto): 50/50 states, 423 facts, 0 multi-source merges
...
_…and 678 more in `state_consolidation_note_v1.json`_
